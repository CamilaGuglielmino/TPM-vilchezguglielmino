<html>
    ...
    <body>
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if(($usuario=="") || ((strlen($usuario)<5) || (strlen($usuario)>10))){
                    $usuarioError="El nombre de usuario debe tener 5 y 10 caracteres, puede contener letras y números, sin espacios en blanco ni caracteres especiales.";
                }
        ...
        <span class="error">*</span> Contrase&ntildea:</a><br>
            <input type="password" name="contra" placeholder="Mínimo 6 caracteres"><br>
        <span class="error"> <?php echo $contraError; ?></span><br><br>

        <span class="error">*</span> Confirmar contrase&ntildea:<br>
            <input type="password" name="contra2" placeholder="Mínimo 6 caracteres"><br>
