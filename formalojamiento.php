<html>
    ...
    <body>
     <?php
      $provError=$ciudadError=$codigoPostalError=$direccionError=$serviciosError="";
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        /*MANEJO DE IMAGENES*/
        $image = $_FILES['fotos'];
        $patch = $_SERVER['DOCUMENT_ROOT']. '/TPM-Guglielmino-Vilchez/img_alojamientos'.'/'.$image['name'];
        ...
        if($codigoPostal==""){
            $codigoPostalError="Ingrese un c&oacutedigo postal.";
        }
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">    
        ...
        <span class="error">*</span> C&oacutedigo postal:<br>
            <input type="number" name="codigoPostal"> <br>
        <span class="error"> <?php echo $codigoPostalError; ?></span><br><br>
       ...
       <?php
           include("controles\control_alojamiento.php");
       ?>
    </body>
</html>